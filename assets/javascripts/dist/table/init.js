...
function(a) {
    ...
    e.length > 0 && e.Paginator({
        totalPages: e.data("pagesTotal"),
        currentPage: e.data("pageCurrent"),
        page: function(a) {
            return b("#pageNumber").val(a).trigger("pageNumber:change"),
            !0
        }
    }),
    ...
    if (g.length > 0) {
        ...
        function() {
            ...
            c = b(this).data("href"),
            e = a.html();
            d.msg.msgbox.confirm(a.data("msg") || d.lang.confirmAllremove,
            function(g) {
                if (g) {
                    ...
                    b.post(c, {
                        ...
                        if (d.issucceed(c)) {
                            d.msg.suc(c.message || d.lang.removeSuccess, c.url);
                            var g = b.Deferred(),
                            j = function(a) {
                                var c = 0;
                        ...
                        } else d.msg.error(c.message || d.lang.removeError, c.url);
                        a.html(e)
                    }).fail(function() {
                        a.html(e),
                        d.msg.info(d.lang.exception)
                    })
                }
            })
        }),
    ...
    function(a) {
        ...
        var g = function() {
            ...
            b.post(e).done(function(a) {
                if (d.issucceed(a)) {
                    d.msg.suc(a.message || d.lang.removeSuccess, a.url);
                    var e = c.parents("tr");
                    e.css({
                ...
                d.msg.error(a.message || d.lang.removeError, a.url)
            }).fail(function() {
                c.button("reset"),
                d.msg.info(d.lang.exception)
            })
        };
        f && d.msg.msgbox.confirm(c.data("msg") || d.lang.confirmRemove,
        function(a) {
            a && g()
        }),
        !f && g()
    ...
    function(a) {
        ...
        c = {
            firstPage: function(b, c, d) {
                var e = a("<li>").append(a('<a href="#">').html(c.first).bind("click.bs-Paginator",
                function() {
                    return b.firstPage(),
                    !1
                }));
            ...
            prevPage: function(b, c, d) {
                var e = a("<li>").append(a('<a href="#">').attr("rel", "prev").html(c.prev).bind("click.bs-Paginator",
                function() {
                    return b.prevPage(),
                    !1
                }));
            ...
            nextPage: function(b, c, d) {
                var e = a("<li>").append(a('<a href="#">').attr("rel", "next").html(c.next).bind("click.bs-Paginator",
                function() {
                    return b.nextPage(),
                    !1
                }));
            ...
            lastPage: function(b, c, d) {
                var e = a("<li>").append(a('<a href="#">').html(c.last).bind("click.bs-Paginator",
                function() {
                    return b.lastPage(),
                    !1
                }));
            ...
            gap: function(b, c) {
                return a("<li>").addClass("disabled").append(a('<a href="#">').html(c.gap))
            },
            page: function(b, c, d) {
...
define("dist/table/talbe-search", ["$", "dist/application/app"],
function(a) {
    "use strict";
    var b = a("$"),
    c = a("dist/application/app"),
    ...
    if (e.length > 0) {
        ...
        if (i.val() && i.val().length > 0) {
            ...
            k.siblings(".th-sortable").append('<span class="th-sort"><i class="fa fa-sort-down text-active"></i><i class="fa fa-sort-up text-active"></i>  <i class="fa fa-sort"></i>  </span>')
        }
        j.on("click",
        function() {
            var a = b(this),
        ...
        function() {
            ...
            return a.length > 0 && 0 == b.trim(a.val()).length ? (d.msg.info("请输入搜索关键词"), !1) : void 0
        })
    }
});